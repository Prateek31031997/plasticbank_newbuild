...
public class ALC_4352  extends BaseClass {
	...
	public static String business_name ="Buss"+RandomStringUtils.randomAlphabetic(5);
	...
	@Test(priority=1, description = "New store account is searchable in Alchemy under the 'Store' section | - Data displayed in user will turn into a field that can be edited | -Changes are saved and can be seen in user details")
