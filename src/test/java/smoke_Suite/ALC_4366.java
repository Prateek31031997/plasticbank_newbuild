...
public class ALC_4366 extends BaseClass {
    ...
    String phoneNumber = "+639561234567";
    ...
    public void tokenTransferAndVerifyInOrdersData() throws InterruptedException {
        ...
        alc_members.tokenDirectTransfer("+639561234567", "Direct Token Transfer", "10","778899", "Transfer Completed");
        alc_orders.verifyOrdersTransferData("Ashish Rawat", "M1 Member", " EPR Rewards", "Token transfer", "10");
    }
    ...
    public void verifyTransferTokenOnApp()throws InterruptedException {
        ...
        pblogin.permission();
        pblogin.login(branchPhoneNumber,password66);
        Thread.sleep(5000);
